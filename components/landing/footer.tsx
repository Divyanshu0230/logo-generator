            ...
            <div className="max-w-6xl mx-auto px-4 w-full flex items-center justify-between">
              <div className="text-sm md:text-base">
                ...
                <div className="text-xs mt-1 text-gray-500 dark:text-gray-400">
                  Made with ❤️ by 
                  <a href="https://github.com/Divyanshu0230" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">Divyanshu Pratap Singh</a>, 2025
                  <span className="mx-1">|</span>
                  <a href="https://www.linkedin.com/in/divyanshu-pratap-singh-304546251/" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">LinkedIn</a>
                </div>
              </div>
              <div className="flex gap-4 items-center justify-center">
                <Link 
                  href="https://github.com/Divyanshu0230" 
                  target="_blank" 
                ...
                <Link 
                  href="https://www.linkedin.com/in/divyanshu-pratap-singh-304546251/" 
                  target="_blank"
                  className="hover:text-primary transition-colors"
                >
